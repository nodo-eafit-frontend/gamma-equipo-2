      ...
      <div className="contentDonacion__row">
        ...
        <div className="contentDonacion__row--2">
          <SelectList
            ...
            id="tipoDocumento"
            options={[
              { label: "Cédula de ciudadanía", value: "cedulaC" },
              { label: "Cédula de extranjería", value: "cedulaE" },
              { label: "Identificación nacional", value: "idNacional" },
              { label: "NIT", value: "nit" },
              { label: "Pasaporte", value: "pasaporte" },
              {
                label: "Documento de identidad país de origen",
                value: "docPaisOrigen",
              },
              { label: "Documento nacional identidad", value: "docPais" },
            ]}
      ...
      <div className="contentDonacion__column">
        ...
        <div className="contentDonacion__column--2">
          ...
          <SelectList
            ...
            id="estadoCivil"
            options={[
              { label: "Soletero/a", value: "soltero" },
              { label: "Casado/a", value: "casado" },
              { label: "Viudo/a", value: "viudo" },
              { label: "Divorcido/a", value: "divorciado" },
            ]}
            placeholder="Seleccione"
          />
          <InputNumber
